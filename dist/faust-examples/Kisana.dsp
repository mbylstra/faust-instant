...
harpe(C,N,b) = 	hand(b) <: par(i, N, position(i+1)
	...
	with {
		...
		hand(48) = vslider("h:[1]Instrument Hands/1 (Note %b)[unit:pk][acc:1 1 -10 0 14]", 0, 0, N, 1)
      : int : automat(120, CCY, 0.0);
		hand(60) = vslider("h:[1]Instrument Hands/2 (Note %b)[unit:pk][acc:1 1 -10 0 14]", 2, 0, N, 1)
      : int : automat(240, CCY, 0.0);
		hand(72) = vslider("h:[1]Instrument Hands/3 (Note %b)[unit:pk][acc:1 1 -10 0 10]", 4, 0, N, 1)
      : int : automat(480, CCY, 0.0);
