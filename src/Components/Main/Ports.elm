...
port measureText : String -> Cmd msg


port incomingTextMeasurements : (Int -> msg) -> Sub msg


port incomingWebfontsActive : ({} -> msg) -> Sub msg
...
port rawMidiInputEvents : (( Int, Int, Int ) -> msg) -> Sub msg
