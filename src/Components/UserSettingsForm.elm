...
import Html.Attributes exposing
  ...
  , name, href, target, src, height, width, alt, defaultValue
  )
  ...
  case action of
    DisplayNameInput s ->
      let
        ...
        newUserModel = { userModel | displayName = s }
      in
        ({ model | userModel = newUserModel, errors' = validate newUserModel }, Nothing)
    Submit ->
