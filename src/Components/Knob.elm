module Gui.Knob exposing
  ( Model
  , Msg(MouseMove, GlobalMouseUp, UpdateParams)
  , init
  , update
  , view
  , EncodedModel
...
update msg model =
  -- case Debug.log "knob msg" msg of
  case msg of
    MouseDown ->
...
view model =
  div []
    [ div
      ...
      , onMouseDownWithOptions preventDefault MouseDown
